...
def test_cast_checked_fraction_raises_type_error_if_collection_contains_non_fraction() -> None:
    throws_test([Fraction(11, 10), "2.1", Fraction(31, 10)],
                lambda x: x.cast.checked.fraction().to_sequence(),
                TypeError)

def test_sum_returns_sum_of_the_values() -> None:
    assert QFractionSequence([Fraction(11, 10), Fraction(21, 10), Fraction(31, 10)]).sum() == Fraction(63, 10)

def test_sum_returns_zero_on_on_empty_collection() -> None:
    assert QFractionSequence().sum() == Fraction(0)

def test_min_returns_min_of_the_values() -> None:
    assert QFractionSequence([Fraction(61, 10), Fraction(21, 10), Fraction(51, 10), Fraction(31, 10)]).min() == Fraction(21, 10)
...
def test_min_or_default_returns_min_of_the_values() -> None:
    assert QFractionSequence([Fraction(61, 10), Fraction(21, 10), Fraction(51, 10), Fraction(31, 10)]).min_or_default() == Fraction(21, 10)

def test_min_or_default_returns_0_on_on_empty_collection() -> None:
    assert QFractionSequence().min_or_default() == Fraction(0)

def test_max_returns_max_of_the_values() -> None:
    assert QFractionSequence([Fraction(11, 10), Fraction(51, 10), Fraction(31, 10)]).max() == Fraction(51, 10)
...
def test_max_or_default_returns_max_of_the_values() -> None:
    assert QFractionSequence([Fraction(11, 10), Fraction(51, 10), Fraction(31, 10)]).max_or_default() == Fraction(51, 10)

def test_max_or_default_returns_0_on_on_empty_collection() -> None:
    assert QFractionSequence().max_or_default() == Fraction(0)

def test_average_returns_average_of_the_values() -> None:
    assert QFractionSequence([Fraction(11, 10), Fraction(21, 10), Fraction(31, 10)]).average() == Fraction(21, 10)
...
def test_average_or_default_returns_average_of_the_values() -> None:
    assert QFractionSequence([Fraction(11, 10), Fraction(21, 10), Fraction(31, 10)]).average_or_default() == Fraction(21, 10)

def test_average_or_default_returns_0_on_on_empty_collection() -> None:
    assert QFractionSequence().average_or_default() == Fraction(0)
...
def test_reversed_returns_qfraction_iterable() -> None:
    result = QFractionSequence([Fraction(11, 10), Fraction(21, 10), Fraction(31, 10)]).reversed()
    # The reversed method returns QFractionIterable (not QFractionSequence specifically)
