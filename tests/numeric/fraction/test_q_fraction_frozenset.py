...
def test_sum_returns_sum_of_the_values() -> None:
    assert QFractionFrozenSet([Fraction(11, 10), Fraction(21, 10), Fraction(31, 10)]).sum() == Fraction(63, 10)

def test_sum_returns_zero_on_on_empty_collection() -> None:
    assert QFractionFrozenSet().sum() == Fraction(0)
...
def test_min_or_default_returns_min_of_the_values() -> None:
    assert QFractionFrozenSet([Fraction(61, 10), Fraction(21, 10), Fraction(51, 10), Fraction(31, 10)]).min_or_default() == Fraction(21, 10)

def test_min_or_default_returns_0_on_on_empty_collection() -> None:
    assert QFractionFrozenSet().min_or_default() == Fraction(0)
...
def test_max_or_default_returns_max_of_the_values() -> None:
    assert QFractionFrozenSet([Fraction(11, 10), Fraction(51, 10), Fraction(31, 10)]).max_or_default() == Fraction(51, 10)

def test_max_or_default_returns_0_on_on_empty_collection() -> None:
    assert QFractionFrozenSet().max_or_default() == Fraction(0)
...
def test_average_or_default_returns_average_of_the_values() -> None:
    assert QFractionFrozenSet([Fraction(11, 10), Fraction(21, 10), Fraction(31, 10)]).average_or_default() == Fraction(21, 10)

def test_average_or_default_returns_0_on_on_empty_collection() -> None:
    assert QFractionFrozenSet().average_or_default() == Fraction(0)
