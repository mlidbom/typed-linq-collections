...
def test_sum_returns_sum_of_the_values() -> None:
    assert QDecimalSet([Decimal("1.1"), Decimal("2.1"), Decimal("3.1")]).sum() == Decimal("6.3")

def test_sum_returns_zero_on_on_empty_collection() -> None:
    assert QDecimalSet().sum() == Decimal(0)

def test_min_returns_min_of_the_values() -> None:
    assert QDecimalSet([Decimal("6.1"), Decimal("2.1"), Decimal("5.1"), Decimal("3.1")]).min() == Decimal("2.1")
...
def test_min_or_default_returns_min_of_the_values() -> None:
    assert QDecimalSet([Decimal("6.1"), Decimal("2.1"), Decimal("5.1"), Decimal("3.1")]).min_or_default() == Decimal("2.1")

def test_min_or_default_returns_0_on_on_empty_collection() -> None:
    assert QDecimalSet().min_or_default() == Decimal(0)

def test_max_returns_max_of_the_values() -> None:
    assert QDecimalSet([Decimal("1.1"), Decimal("5.1"), Decimal("3.1")]).max() == Decimal("5.1")
...
def test_max_or_default_returns_max_of_the_values() -> None:
    assert QDecimalSet([Decimal("1.1"), Decimal("5.1"), Decimal("3.1")]).max_or_default() == Decimal("5.1")

def test_max_or_default_returns_0_on_on_empty_collection() -> None:
    assert QDecimalSet().max_or_default() == Decimal(0)

def test_average_returns_average_of_the_values() -> None:
    assert QDecimalSet([Decimal("1.1"), Decimal("2.1"), Decimal("3.1")]).average() == Decimal("2.1")
...
def test_average_or_default_returns_average_of_the_values() -> None:
    assert QDecimalSet([Decimal("1.1"), Decimal("2.1"), Decimal("3.1")]).average_or_default() == Decimal("2.1")

def test_average_or_default_returns_0_on_on_empty_collection() -> None:
    assert QDecimalSet().average_or_default() == Decimal(0)

def test_to_set_returns_a_set_with_the_same_elements() -> None:
    assert QDecimalSet([Decimal("1.1"), Decimal("2.1"), Decimal("3.1")]).to_set() == {Decimal("1.1"), Decimal("2.1"), Decimal("3.1")}

def test_constructor_with_no_arguments_creates_empty_collection() -> None:
    empty_set = QDecimalSet()
